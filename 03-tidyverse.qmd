...
Na imagem, temos todas as camadas que são utilizadas pelo ggplot2, seguindo a ordem debaixo para cima. Além das 3 mais importantes, ainda temos a cama da escala...

![](images/ggplot2.png){fig-align="center" width="452"}
...
Para comparar a distribuição de uma variável numérica entre diferentes categorias, o boxplot[^03-tidyverse-3] (`geom_boxplot()`) é uma excelente ferramenta. Para isso, vamos comparar a distribuição da massa corporal entre as três espécies.

[^03-tidyverse-3]: Também chamado por gráfico de caixas.
