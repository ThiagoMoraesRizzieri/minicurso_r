...
### Conceitos importantes ao aplicar um modelo de Aprendizado de Máquina
...
-   **Viés versus variância:** O **viés** é o erro que o modelo comete por ser muito simples (subajuste). A **variância** é o erro do modelo por ser muito complexo e sensível a pequenas variações nos dados de treinamento (sobreajuste). Encontrar o equilíbrio entre os dois é crucial.
