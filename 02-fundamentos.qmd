...
-   **RStudio** é um Ambiente de Desenvolvimento Integrado (IDE, do inglês *Integrated Development Environment*). Se o R é o motor do carro, o RStudio[^02-fundamentos-1] é o painel, o volante, e todo o interior que torna a condução do carro uma experiência agradável e gerenciável. O RStudio fornece uma interface gráfica e amigável que organiza o trabalho em R, facilitando a escrita de *scripts* (arquivos de códigos), a visualização de gráficos, o gerenciamento de pacotes (bibliotecas) e muito mais. Embora seja possível utilizar o R sem o RStudio, a utilização do RStudio é fortemente recomendada, pois deixa o processo de análise muito mais interativo e organizado.

[^02-fundamentos-1]: Existem outras IDEs que podem ser utilizadas no lugar do RStudio, como o Visual Studio Code. No entanto, focaremos nosso estudo utilizando o RStudio.

![](images/rstudio.png){fig-align="center" width="464"}
...
-   Acesse o [site](https://cran.r-project.org/) do *Comprehensive R Archive Network* (CRAN)[^02-fundamentos-2], que é o repositório oficial para o R e seus pacotes.
...
[^02-fundamentos-2]: Um outro repositório conhecido na comunidade científica para pacotes com o intuítuo de modelagem na biologia, em especial na genética, é o [Bioconductor](https://www.bioconductor.org/).

![](images/clipboard-2887599601.png)
...
![](images/clipboard-386187942.png)
...
<!-- Retirar os pacotes de modelos mistos e substituir por ggplot2? -->
...
Os operadores matemáticos, também conhecidos por operadores binários, dentro do ambiente R soam como familiares. A @tbl-op-mat exibe os operadores mais básicos utilizados.
